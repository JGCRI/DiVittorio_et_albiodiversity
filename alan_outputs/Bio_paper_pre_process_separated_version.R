...
test_adjust = GCAM_Availability$suit_prot_area_km2[e_inds] - GCAM_Availability$excess_area[e_inds]
...
# the assumption here is that scenario protected is taken out of suitable unprotected first, then unsuitable unprotected
# this must align with the separated version because the scenario protects entire cells
# now add the unsuitable unprotected, which is the remaining amount of default unavailable land
...
# now add the default unavailable data as protected, keeping track of suitable and unsuitale protected
...
# this sum should not be the same as the total unavailable just below
...
global_vals_df = data.frame(Scenario, Protected_or_Unavailable_land_km2, Protected_or_Unavailable_percent_land, Protected_percent_land, Unsuitable_and_Unprotected_percent_land,
							Suitable_Protected_land_km2, Suitable_Protected_percent_land, Unsuitable_land_km2, Unsuitable_percent_land)
